<?php if ( get_theme_mod( 'yourseobook_main_land_users_reviews_display_control' ) ) : ?>

<div class="container-fluid" style="background:#FFF;">
<div class="container">
  <div class="row align-items-center ms-auto userreviews" style="margin:40px 0px 40px 0px;padding:40px 20px 40px 20px;">

<h2 class="display-5 fw-bold text-body-emphasis">What our Clients Say</h2>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Client Testimonials Title</h3>
          <p>Client Testimonials Short Description about the services and review text   </p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
