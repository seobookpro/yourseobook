...
<h2 class="display-5 fw-bold text-body-emphasis">Company Case Studies</h2>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Client Case Study Title</h3>
          <p>Client Name Case Study and Short Description about the Case</p>
        </div>
      </div>
      <div class="col d-flex align-items-start">
